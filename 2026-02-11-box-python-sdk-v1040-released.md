...
subcategory_id: ''
id: 2026-02-11-box-python-sdk-v1040-released
rank: null
total_steps: null
type: changelog
sibling_id: ''
...
source_url: >-
  https://github.com/box/box-developer-changelog/blob/main/content/2026/02-11-box-python-sdk-v1040-released.md
published_at: '2026-02-11'
fullyTranslated: true
---
# Box Python SDK `v10.4.0`のリリース

### バグ修正

* リーガルホールドポリシーの変更に合わせて列挙値を修正 (box/box-openapi[#581][1]) ([#1304][2]) ([`d51b4ea`][3])

### 新機能と機能強化

* 抽出 (構造化) の信頼度スコアを追加 (box/box-openapi[#582][4]) ([#1311][5]) ([`9db7a80`][6])
* 署名者の言語を追加し、署名リクエストの理由をキャンセル (box/box-openapi[#584][7]) ([#1331][8]) ([`fcca2a4`][9])
* 電子すかしの権限とソースの情報を追加 (box/box-openapi[#579][10]) ([#1300][11]) ([`7a2c7e3`][12])
